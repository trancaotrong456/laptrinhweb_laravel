...
|--------------------------------------------------------------------------
| USER thường vẫn truy cập được
*/

Route::get(
    '/do-uong',
    [CategoryController::class, 'doUong']
)->name('categories.do_uong');

Route::get(
    '/thuc-pham',
    [CategoryController::class, 'thucPham']
)->name('categories.thuc_pham');

Route::get(
    '/gia-dung',
    [CategoryController::class, 'giaDung']
)->name('categories.gia_dung');

Route::get(
    '/categories/search-suggestions',
    [CategoryController::class, 'searchSuggestions']
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::get(
        '/coupons/saved',
        [\App\Http\Controllers\SavedCouponController::class, 'index']
    )->name('coupons.saved');
