...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Siêu thị Mini'); ?></title>
...
<body class="position-relative">
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-0 px-4">
        <div class="container-fluid">
            <!-- Logo -->
            <a class="navbar-brand fw-bold fs-3 lh-1" href="<?php echo e(route('home')); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-2">
                    ...
                    <li class="nav-item">
                    <li><a class="nav-link" href="<?php echo e(route('categories.index')); ?>">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="guest-buttons d-none d-lg-flex">
                        <a class="btn btn-outline-primary rounded-pill px-4 py-2" href="<?php echo e(route('login')); ?>">
                            <i class="fas fa-sign-in-alt me-1"></i>Đăng nhập
                        </a>
                        <a class="btn btn-primary rounded-pill px-4 py-2" href="<?php echo e(route('user.createUser')); ?>">
                    ...
                    <a href="<?php echo e(route('cart.index')); ?>"
                        ...
                        <span class="cart-badge">
                            <?php echo e(Session::has('cart') ? array_sum(array_column(Session::get('cart', []), 'quantity')) : 0); ?>
                    ...
                    <div class="dropdown user-dropdown">
                        <a class="dropdown-toggle nav-link p-0 rounded-pill d-flex align-items-center gap-3 text-decoration-none"
                            ...
                            <span class="d-none d-md-inline"><?php echo e(Str::limit(Auth::user()->name, 12)); ?></span>
                        ...
                        <ul class="dropdown-menu shadow-xl border-0 rounded-4">
                            <li>
                                <div class="px-3 py-3">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <h6 class="mb-1 fw-bold"><?php echo e(Auth::user()->name); ?></h6>
                            ...
                            <li><a class="dropdown-item rounded-3 d-flex align-items-center gap-3"
                                    href="<?php echo e(route('user.listUser')); ?>">
...
<body>
    <nav>
        <ul>
            ...
            <?php else: ?>
            <li><a href="<?php echo e(route('dashboard')); ?>">Bảng điều khiển</a></li>
...
</html><?php /**PATH C:\Users\PHONG\Documents\laravel-demo\laravel\resources\views/layout.blade.php ENDPATH**/ ?>