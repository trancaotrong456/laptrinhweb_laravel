<?php $__env->startSection('title', 'Đăng ký thành viên - Siêu thị Mini'); ?>
                ...
                <div class="card-body p-5">
                    ...
                    <div class="alert alert-danger rounded-4 shadow-sm mb-4 animate-pulse">
                        ...
                        <ul class="mb-0 list-unstyled">
                            ...
                            <li class="small"><i class="fas fa-times-circle me-1 text-danger"></i><?php echo e($error); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    <?php endif; ?>

                    <form action="<?php echo e(route('user.postUser')); ?>" method="POST" class="row g-4">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="email"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control form-control-lg <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                name="dob" value="<?php echo e(old('dob')); ?>" max="<?php echo e(now()->format('Y-m-d')); ?>">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Số điện thoại</label>
                            <input type="tel" class="form-control form-control-lg <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                name="phone" value="<?php echo e(old('phone')); ?>" placeholder="0123456789">
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                name="address" rows="3"
                                placeholder="Số nhà, đường, phường, quận..."><?php echo e(old('address')); ?></textarea>
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="mt-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="gender" id="male2" value="Nam"
                                        <?php echo e(old('gender', 'Nam') == 'Nam' ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="gender" id="female2" value="Nữ"
                                        <?php echo e(old('gender') == 'Nữ' ? 'checked' : ''); ?>>
                        ...
                        <div class="col-12 text-center pt-3">
                            <small class="text-muted">
                                Đã có tài khoản?
                                <a href="<?php echo e(route('login')); ?>" class="text-primary fw-semibold">Đăng nhập tại đây</a>
                            </small>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PHONG\Documents\laravel-demo\laravel\resources\views/crud_user/create.blade.php ENDPATH**/ ?>