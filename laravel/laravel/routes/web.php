...
// AJAX live search posts (public)
Route::get('/khuyen-mai-search', [PostController::class, 'searchAjax'])->name('posts.search');
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    // ── POSTS: Comment & Like ──────────────────────────────
    Route::post('/khuyen-mai/{id}/comment',        [PostController::class, 'storeComment'])->name('posts.comment.store');
    Route::put('/khuyen-mai/comment/{commentId}',  [PostController::class, 'updateComment'])->name('posts.comment.update');
    Route::delete('/khuyen-mai/comment/{commentId}', [PostController::class, 'destroyComment'])->name('posts.comment.destroy');
