    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <form action="{{ route('categories.index') }}" method="GET" class="search-box me-lg-4">
                    <input type="text" name="search" class="search-input" placeholder="Tìm kiếm danh mục, sản phẩm..."
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        ...
                        <a class="nav-link border-0 p-0 d-flex align-items-center gap-3 user-dropdown-toggle" href="#"
            ...
            fetch("{{ route('cart.add') }}", {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        // TOAST (Bạn code đoạn này cực kì tốt thay vì dùng alert! Mình giữ nguyên 100%)
